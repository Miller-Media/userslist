...
(function( $, undefined ) {
	...
	var mainController;
	mwp.on( 'millermedia-userslist.ready', function(c){ mainController = c; } );
	 ...
	 * Example:
	 *
	 * <div data-view-model="millermedia-userslist">
	 *   <span data-bind="text: title"></span>
	 * </div>
	 */
	mwp.controller.model( 'millermedia-userslist', 
	{
		...
		init: function()
		{
			...
			this.viewModel = {
				title: ko.observable( 'Users List' )
			};
		}
